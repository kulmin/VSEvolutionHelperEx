...
/// <summary>
/// Adds evolution and union tooltips to the affected-item icons in the arcana information panel.
/// Both icon containers are registered because the game switches between them by layout. The
/// wiring pass uses scene objects rather than retaining an unsafe panel instance.
/// </summary>
public static class ArcanaWeaponPatches
{
    ...
    public static void Apply(Harmony harmony)
    {
        ...
        try
        {
            // Bind before the game reduces each item to an untyped sprite.
