...
public static class AdventureSelectPatches
{
    ...
    public static void Tick()
    {
        ...
        try
        {
            var any = UnityObjectQuery.FindAny<AdventureItemUI>();
    ...
    public static void ScanAndRegister()
    {
        ...
        try
        {
            ...
            try { uis = UnityObjectQuery.FindAll<AdventureItemUI>(true); }
            catch { try { uis = UnityObjectQuery.FindAll<AdventureItemUI>(); } catch { } }
    ...
    private static bool TryBuildData(AdventureItemUI ui, out TooltipData td)
    {
        ...
        try
        {
            ...
            try { data = ui.GetAdventureData(); } catch { try { data = RuntimeAccess.Get<AdventureData>(ui, "_data"); } catch { } }
            try { type = ui.GetAdventureType(); } catch { try { type = RuntimeAccess.Get<AdventureType>(ui, "_type"); } catch { } }
            ...
            try
            {
                var icon = RuntimeAccess.Get<Image>(ui, "_Icon");
    ...
    private static string ResolveTitle(AdventureItemUI ui, AdventureData data, AdventureType type)
    {
        try
        {
            var title = RuntimeAccess.Get<TMPro.TextMeshProUGUI>(ui, "_Title");
            if ((Object)(object)title != (Object)null)
            {
                string t = ((TMPro.TMP_Text)title).text;
