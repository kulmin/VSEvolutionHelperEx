...
#if VSEH_MONO
using RuntimeNullableWeapon = System.Nullable<VampireSurvivors.Data.WeaponType>;
using RuntimeSkinList = System.Collections.Generic.List<VampireSurvivors.Data.Characters.Skin>;
using RuntimeRaycastResults = System.Collections.Generic.List<UnityEngine.EventSystems.RaycastResult>;
#else
using RuntimeNullableWeapon = Il2CppSystem.Nullable<VampireSurvivors.Data.WeaponType>;
using RuntimeSkinList = Il2CppSystem.Collections.Generic.List<VampireSurvivors.Data.Characters.Skin>;
using RuntimeRaycastResults = Il2CppSystem.Collections.Generic.List<UnityEngine.EventSystems.RaycastResult>;
#endif
...
public static class CharacterSelectPatches
{
    ...
    public static void Tick()
    {
        ...
        try
        {
            var any = UnityObjectQuery.FindAny<CharacterItemUI>();
    ...
    public static void ScanAndRegister()
    {
        ...
        try
        {
            ...
            try { uis = UnityObjectQuery.FindAll<CharacterItemUI>(true); }
            catch { try { uis = UnityObjectQuery.FindAll<CharacterItemUI>(); } catch { } }
    ...
    private static bool RegisterOne(CharacterItemUI ui)
    {
        ...
        try
        {
            var weaponIcon = RuntimeAccess.Get<Image>(ui, "_WeaponIcon");
            if ((Object)(object)weaponIcon != (Object)null)
            {
                var go = ((Component)weaponIcon).gameObject;
                HitToUi[((Object)go).GetInstanceID()] = ui;
                ((Graphic)weaponIcon).raycastTarget = true;
            }
        }
        catch { }
        try
        {
            var characterIcon = RuntimeAccess.Get<Image>(ui, "_CharacterIcon");
            if ((Object)(object)characterIcon != (Object)null)
            {
                var go = ((Component)characterIcon).gameObject;
                HitToUi[((Object)go).GetInstanceID()] = ui;
                ((Graphic)characterIcon).raycastTarget = true;
            }
        }
        catch { }
            ...
            if (starter.HasValue && GameData.IsRealWeaponType(starter.Value))
            {
                ...
                else
                {
                    ...
                    if ((Object)(object)data.StarterSprite == (Object)null)
                    {
                        try
                        {
                            Image w = RuntimeAccess.Get<Image>(ui, "_WeaponIcon");
    ...
    private static WeaponType? ResolveStartingWeapon(CharacterItemUI ui, CharacterData cdata, Skin skin)
    {
        ...
        try
        {
            ...
            try { voidWeapon = RuntimeAccess.Get<bool>(ui, "_voidWeapon"); } catch { }
            if (!voidWeapon)
            {
                Image w = RuntimeAccess.Get<Image>(ui, "_WeaponIcon");
                if ((Object)(object)w != (Object)null
    ...
    private static WeaponType? ReadNullableWeaponValue(RuntimeNullableWeapon n)
    {
    ...
    private static string FormatOtherOutfitWeapons(CharacterData cdata, WeaponType? currentStarter)
    {
        ...
        RuntimeSkinList skins = null;
        try { skins = cdata.skins; } catch { }
    ...
    private static string SafeDisplayName(CharacterItemUI ui, CharacterItem item)
    {
        ...
        try
        {
            var characterName = RuntimeAccess.Get<TMPro.TextMeshProUGUI>(ui, "_CharacterName");
            if ((Object)(object)characterName != (Object)null)
            {
                string t = Scrub(((TMPro.TMP_Text)characterName).text);
    ...
    private static Sprite ResolveCharacterSprite(CharacterItemUI ui)
    {
        try
        {
            Image icon = RuntimeAccess.Get<Image>(ui, "_CharacterIcon");
    ...
    public static bool TryFindHoveredCard(Vector2 screenPos, out int hitId, out GameObject hitGo)
    {
        ...
        try
        {
            ...
            if ((Object)(object)es != (Object)null)
            {
                ...
                var results = new RuntimeRaycastResults();
